  ...
  describe ".connection" do
      ...
      describe "after setting a new token" do
        ...
        it "called to RestClient::Resource using the new token" do
          RestClient::Resource.should_receive(:new).
              with(PivotalTracker::Client.api_url, :headers => { 'X-TrackerToken' => "anewtoken", 'Content-Type' => 'application/json' })
    ...
    context "with an existing token" do
      ...
      it "returned a RestClient::Resource using the token" do
        ...
        RestClient::Resource.should_receive(:new).
            with(PivotalTracker::Client.api_url, :headers => { 'X-TrackerToken' => "abc123", 'Content-Type' => 'application/json' }).
            and_return(@resource)
  ...
  describe "#api_url" do
    context "when not passed a username and password" do
      ...
      it "returns https://www.pivotaltracker.com/services/v5" do
        PivotalTracker::Client.api_url.should == 'https://www.pivotaltracker.com/services/v5'
      end
    end
    context "when passed a username and password" do
      ...
      it "returns https://USER:PASSWORD@www.pivotaltracker.com/services/v3" do
        PivotalTracker::Client.api_url('USER', 'PASSWORD').should == 'https://USER:PASSWORD@www.pivotaltracker.com/services/v3'
      end
    end
  end
